  ...
  <body>
    ...
    <script>
      ...
      var countries = {
        ...
        'ind': {
          center: {lat: -0.9342375 , lng: 100.251181},
          zoom: 8
        }
      };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA1TwYksj1uQg1V_5yPUZqwqYYtUIvidrY&libraries=places&callback=initMap"
        async defer></script>
  </body>
</html>