...
<html>
  ...
  <?php include('include/sidebar.php');
        $data=pg_query("SELECT * from  detail_pelapor 
                        WHERE id_laporan='$id'")or die(pg_error());                      
                  ...
                  <section class="panel">
                      <header class="panel-heading">
                          ...
                          <form class="form-inline">
                              <input id="latlng" type="text" class="form-control" style="width:200px"  placeholder="Latitude, Longitude">
...
<div class="panel-body">
        ...
        <?php
          ...
          $data=pg_query("SELECT * from detail_pelapor INNER JOIN orang 
                        ON detail_pelapor.id_orang = orang.id_orang
                                WHERE id_laporan='$id'")or die(pg_error());                      
        ...
        <table>
                <div class="form-group">
                    <br>
                     ...
                     <?php 
                     $query_geom = pg_query("SELECT * FROM detail_pelapor WHERE id_laporan = '$id'");
            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pelapor" value="<?=$hasil['nama_orang'];?>" autocomplete="off">
                  
                    <br><br>
                    <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?=$hasil['no_hp']?>" autocomplete="off">
                </div>
