...
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","0983048",actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getsupportedhardwarelevel" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(16384);
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","01572865",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_error),0);
...
Debug.ShouldStop(16);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","01114126",RemoteObject.concat(RemoteObject.createImmutable("Start success: "),_success),0);
...
Debug.ShouldStop(67108864);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","01638407",RemoteObject.concat(RemoteObject.createImmutable("Picture taken: "),_bmp),0);
