...
anywheresoftware.b4a.keywords.Common.LogImpl("0983048",mostCurrent._cam._getsupportedhardwarelevel /*String*/ (null),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("01114126","Start success: "+BA.ObjectToString(_success),0);
...
RDebugUtils.currentLine=1638402;
 //BA.debugLineNum = 1638402;BA.debugLine="SetState(openstate, True, VideoMode)";
_setstate(parent._openstate,anywheresoftware.b4a.keywords.Common.True,parent._videomode);
RDebugUtils.currentLine=1638403;
 //BA.debugLineNum = 1638403;BA.debugLine="Wait For(cam.FocusAndTakePicture(MyTaskIndex)) C";
...
RDebugUtils.currentLine=1638404;
 //BA.debugLineNum = 1638404;BA.debugLine="SetState(openstate, False, VideoMode)";
_setstate(parent._openstate,anywheresoftware.b4a.keywords.Common.False,parent._videomode);
RDebugUtils.currentLine=1638405;
 //BA.debugLineNum = 1638405;BA.debugLine="cam.DataToFile(Data, VideoFileDir, \"1.jpg\")";
parent.mostCurrent._cam._datatofile /*String*/ (null,_data,parent._videofiledir,"1.jpg");
RDebugUtils.currentLine=1638406;
 //BA.debugLineNum = 1638406;BA.debugLine="Dim bmp As Bitmap = cam.DataToBitmap(Data)";
...
RDebugUtils.currentLine=1638407;
 //BA.debugLineNum = 1638407;BA.debugLine="Log(\"Picture taken: \" & bmp) 'ignore";
anywheresoftware.b4a.keywords.Common.LogImpl("01638407","Picture taken: "+BA.ObjectToString(_bmp),0);
RDebugUtils.currentLine=1638408;
 //BA.debugLineNum = 1638408;BA.debugLine="pnlBackground.SetVisibleAnimated(100, True)";
parent.mostCurrent._pnlbackground.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=1638409;
 //BA.debugLineNum = 1638409;BA.debugLine="pnlPicture.SetBackgroundImage(bmp.Resize(pnlPict";
...
RDebugUtils.currentLine=1638410;
 //BA.debugLineNum = 1638410;BA.debugLine="Sleep(4000)";
...
RDebugUtils.currentLine=1638411;
 //BA.debugLineNum = 1638411;BA.debugLine="pnlBackground.SetVisibleAnimated(500, False)";
...
RDebugUtils.currentLine=1638413;
 //BA.debugLineNum = 1638413;BA.debugLine="HandleError(LastException)";
_handleerror(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA));
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("01572865","Error: "+BA.ObjectToString(_error),0);
