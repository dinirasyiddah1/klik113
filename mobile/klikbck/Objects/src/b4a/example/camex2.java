...
__c.LogImpl("82490373",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("82031624","Camera not found.",0);
...
parent.__c.LogImpl("82031630","Failed to open camera",0);
...
parent.__c.LogImpl("84063236","Focus not supported",0);
 if (true) break;
...
parent.__c.LogImpl("84063244","Focus failed",0);
 if (true) break;
...
parent.__c.LogImpl("84063246","Focused!",0);
 if (true) break;
...
__c.LogImpl("84849670",BA.ObjectToString(_consts),0);
RDebugUtils.currentLine=4849671;
 //BA.debugLineNum = 4849671;BA.debugLine="Log(\"Unknown const: \" & i)";
__c.LogImpl("84849671","Unknown const: "+BA.NumberToString(_i),0);
...
__c.LogImpl("84915209",BA.ObjectToString(_consts),0);
RDebugUtils.currentLine=4915210;
 //BA.debugLineNum = 4915210;BA.debugLine="Log(\"Unknown consts: \" & mode)";
__c.LogImpl("84915210","Unknown consts: "+BA.NumberToString(_mode),0);
 };
 }
};
...
__c.LogImpl("85111809",("******  "+__c.SmartStringFormatter("",(Object)(_title))+" **********"),0);
...
__c.LogImpl("85111827",(""+__c.SmartStringFormatter("",_k.RunMethod("getName",(Object[])(__c.Null)))+": "+__c.SmartStringFormatter("",_value)+""),0);
 }
};
