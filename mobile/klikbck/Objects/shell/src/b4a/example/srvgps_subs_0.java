...
try {
		Debug.PushSubsStack("Application_Error (srvgps) ","srvgps",7,srvgps.processBA,srvgps.mostCurrent,40);
...
try {
		Debug.PushSubsStack("GPS_LocationChanged (srvgps) ","srvgps",7,srvgps.processBA,srvgps.mostCurrent,34);
...
Debug.ShouldStop(2);
 BA.debugLineNum = 35;BA.debugLine="CallSub2(actGPS, \"LocationChanged\", Location1)";
Debug.ShouldStop(4);
srvgps.mostCurrent.__c.runMethodAndSync(false,"CallSubNew2",srvgps.processBA,(Object)((srvgps.mostCurrent._actgps.getObject())),(Object)(BA.ObjectToString("LocationChanged")),(Object)((_location1)));
...
try {
		Debug.PushSubsStack("Service_Create (srvgps) ","srvgps",7,srvgps.processBA,srvgps.mostCurrent,12);
...
try {
		Debug.PushSubsStack("Service_Destroy (srvgps) ","srvgps",7,srvgps.processBA,srvgps.mostCurrent,44);
...
try {
		Debug.PushSubsStack("Service_Start (srvgps) ","srvgps",7,srvgps.processBA,srvgps.mostCurrent,16);
...
try {
		Debug.PushSubsStack("StartGps (srvgps) ","srvgps",7,srvgps.processBA,srvgps.mostCurrent,20);
...
try {
		Debug.PushSubsStack("StopGps (srvgps) ","srvgps",7,srvgps.processBA,srvgps.mostCurrent,27);
