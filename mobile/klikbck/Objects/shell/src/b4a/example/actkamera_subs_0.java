...
try {
		Debug.PushSubsStack("Activity_Create (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,18);
...
Debug.ShouldStop(131072);
 BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"kamera\")";
...
try {
		Debug.PushSubsStack("Activity_Pause (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,24);
