...
public static b4a.example.actgps _actgps = null;
  public Object[] GetGlobals() {
		return new Object[] {"actGPS",Debug.moduleToString(b4a.example.actgps.class),"actKamera",Debug.moduleToString(b4a.example.actkamera.class),"actLapor",Debug.moduleToString(b4a.example.actlapor.class),"gps",Debug.moduleToString(b4a.example.gps.class),"GPS1",srvgps._gps1,"gpsStarted",srvgps._gpsstarted,"Main",Debug.moduleToString(b4a.example.main.class),"rp",srvgps._rp,"Service",srvgps.mostCurrent._service,"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}