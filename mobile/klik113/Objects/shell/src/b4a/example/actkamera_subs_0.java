...
try {
		Debug.PushSubsStack("Activity_Create (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,37);
...
Debug.ShouldStop(16);
 BA.debugLineNum = 40;BA.debugLine="VideoFileDir = rp.GetSafeDirDefaultExternal(\"\")";
Debug.ShouldStop(128);
actkamera._videofiledir = actkamera._rp.runMethod(true,"GetSafeDirDefaultExternal",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 41;BA.debugLine="VideoFileName = \"1.mp4\"";
Debug.ShouldStop(256);
actkamera._videofilename = BA.ObjectToString("1.mp4");
 BA.debugLineNum = 42;BA.debugLine="Activity.LoadLayout(\"kamera\")";
...
actkamera.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("kamera")),actkamera.mostCurrent.activityBA);
 BA.debugLineNum = 43;BA.debugLine="Activity.LoadLayout(\"StillPicture\")";
...
actkamera.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("StillPicture")),actkamera.mostCurrent.activityBA);
 BA.debugLineNum = 44;BA.debugLine="cam.Initialize(pnlCamera)";
...
actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_initialize" /*RemoteObject*/ ,actkamera.mostCurrent.activityBA,(Object)(actkamera.mostCurrent._pnlcamera));
 BA.debugLineNum = 45;BA.debugLine="Log(cam.SupportedHardwareLevel)";
Debug.ShouldStop(4096);
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","8917512",actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getsupportedhardwarelevel" /*RemoteObject*/ ),0);
 BA.debugLineNum = 46;BA.debugLine="buttons = Array(btnAutoExposure, btnMode)";
...
actkamera.mostCurrent._buttons = actkamera.mostCurrent.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(actkamera.mostCurrent._btnautoexposure.getObject()),(actkamera.mostCurrent._btnmode.getObject())})));
 BA.debugLineNum = 47;BA.debugLine="SetState(False, False, VideoMode)";
...
_setstate(actkamera.mostCurrent.__c.getField(true,"False"),actkamera.mostCurrent.__c.getField(true,"False"),actkamera._videomode);
 BA.debugLineNum = 49;BA.debugLine="SQL1.Initialize (File.DirDefaultExternal,\"databas";
Debug.ShouldStop(65536);
actkamera._sql1.runVoidMethod ("Initialize",(Object)(actkamera.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirDefaultExternal")),(Object)(BA.ObjectToString("database.db")),(Object)(actkamera.mostCurrent.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("Activity_Pause (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,101);
...
Debug.ShouldStop(16);
 BA.debugLineNum = 102;BA.debugLine="cam.Stop";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("Activity_Resume (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,55);
...
Debug.ShouldStop(4194304);
 BA.debugLineNum = 56;BA.debugLine="OpenCamera(frontCamera)";
...
try {
		Debug.PushSubsStack("barZoom_ValueChanged (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,217);
...
Debug.locals.put("UserChanged", _userchanged);
 BA.debugLineNum = 217;BA.debugLine="Sub barZoom_ValueChanged (Value As Int, UserChange";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 218;BA.debugLine="Dim OriginalSize As Rect = cam.ActiveArraySize";
...
_originalsize = actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getactivearraysize" /*RemoteObject*/ );Debug.locals.put("OriginalSize", _originalsize);Debug.locals.put("OriginalSize", _originalsize);
 BA.debugLineNum = 219;BA.debugLine="Dim Zoom As Float = 1 + Value / 100 * (cam.MaxDig";
...
_zoom = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(1),_value,RemoteObject.createImmutable(100),(RemoteObject.solve(new RemoteObject[] {actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getmaxdigitalzoom" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "-",1, 0))}, "+/*",1, 0));Debug.locals.put("Zoom", _zoom);Debug.locals.put("Zoom", _zoom);
 BA.debugLineNum = 220;BA.debugLine="Dim Crop As Rect";
...
_crop = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper");Debug.locals.put("Crop", _crop);
 BA.debugLineNum = 221;BA.debugLine="Dim NewWidth As Int = OriginalSize.Width / Zoom";
...
_newwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getWidth"),_zoom}, "/",0, 0));Debug.locals.put("NewWidth", _newwidth);Debug.locals.put("NewWidth", _newwidth);
 BA.debugLineNum = 222;BA.debugLine="Dim NewHeight As Int = OriginalSize.Height / Zoom";
...
_newheight = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getHeight"),_zoom}, "/",0, 0));Debug.locals.put("NewHeight", _newheight);Debug.locals.put("NewHeight", _newheight);
 BA.debugLineNum = 223;BA.debugLine="Crop.Initialize(OriginalSize.CenterX - NewWidth /";
...
_crop.runVoidMethod ("Initialize",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterX"),_newwidth,RemoteObject.createImmutable(2)}, "-/",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterY"),_newheight,RemoteObject.createImmutable(2)}, "-/",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterX"),_newwidth,RemoteObject.createImmutable(2)}, "+/",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterY"),_newheight,RemoteObject.createImmutable(2)}, "+/",1, 0))));
 BA.debugLineNum = 225;BA.debugLine="cam.PreviewCropRegion = Crop";
Debug.ShouldStop(1);
actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_setpreviewcropregion",_crop);
 BA.debugLineNum = 226;BA.debugLine="cam.StartPreview(MyTaskIndex, VideoMode)";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("btnAutoExposure_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,183);
...
RemoteObject _i = RemoteObject.createImmutable(0);
 BA.debugLineNum = 183;BA.debugLine="Sub btnAutoExposure_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 184;BA.debugLine="Dim flashes As List = cam.SupportedAutoExposureMo";
Debug.ShouldStop(8388608);
...
_flashes = actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getsupportedautoexposuremodes" /*RemoteObject*/ );Debug.locals.put("flashes", _flashes);Debug.locals.put("flashes", _flashes);
 BA.debugLineNum = 185;BA.debugLine="Dim i As Int = flashes.IndexOf(cam.AutoExposureMo";
Debug.ShouldStop(16777216);
_i = _flashes.runMethod(true,"IndexOf",(Object)((actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getautoexposuremode" /*RemoteObject*/ ))));Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 186;BA.debugLine="i = (i + 1) Mod flashes.Size";
Debug.ShouldStop(33554432);
_i = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1)),_flashes.runMethod(true,"getSize")}, "%",0, 1);Debug.locals.put("i", _i);
 BA.debugLineNum = 187;BA.debugLine="cam.AutoExposureMode = flashes.Get(i)";
Debug.ShouldStop(67108864);
actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_setautoexposuremode" /*RemoteObject*/ ,BA.ObjectToString(_flashes.runMethod(false,"Get",(Object)(_i))));
 BA.debugLineNum = 188;BA.debugLine="btnAutoExposure.Text = flashes.Get(i)";
Debug.ShouldStop(134217728);
actkamera.mostCurrent._btnautoexposure.runMethod(true,"setText",BA.ObjectToCharSequence(_flashes.runMethod(false,"Get",(Object)(_i))));
 BA.debugLineNum = 189;BA.debugLine="cam.StartPreview(MyTaskIndex, VideoMode)";
Debug.ShouldStop(268435456);
actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_startpreview" /*RemoteObject*/ ,(Object)(actkamera._mytaskindex),(Object)(actkamera._videomode));
...
try {
		Debug.PushSubsStack("btnCamera_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,96);
if (RapidSub.canDelegate("btncamera_click")) { return b4a.example.actkamera.remoteMe.runUserSub(false, "actkamera","btncamera_click");}
 BA.debugLineNum = 96;BA.debugLine="Sub btnCamera_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 97;BA.debugLine="frontCamera = Not(frontCamera)";
Debug.ShouldStop(1);
actkamera._frontcamera = actkamera.mostCurrent.__c.runMethod(true,"Not",(Object)(actkamera._frontcamera));
 BA.debugLineNum = 98;BA.debugLine="OpenCamera(frontCamera)";
Debug.ShouldStop(2);
_opencamera(actkamera._frontcamera);
...
try {
		Debug.PushSubsStack("btnMode_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,105);
...
//C
this.state = 1;
 BA.debugLineNum = 106;BA.debugLine="VideoMode = Not(VideoMode)";
Debug.ShouldStop(512);
parent._videomode = parent.mostCurrent.__c.runMethod(true,"Not",(Object)(parent._videomode));
 BA.debugLineNum = 107;BA.debugLine="If VideoMode Then";
Debug.ShouldStop(1024);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 108;BA.debugLine="rp.CheckAndRequest(rp.PERMISSION_RECORD_AUDIO)";
Debug.ShouldStop(2048);
parent._rp.runVoidMethod ("CheckAndRequest",actkamera.processBA,(Object)(parent._rp.getField(true,"PERMISSION_RECORD_AUDIO")));
 BA.debugLineNum = 109;BA.debugLine="Wait For Activity_PermissionResult (Permission A";
Debug.ShouldStop(4096);
...
;
 BA.debugLineNum = 110;BA.debugLine="If Result = False Then";
Debug.ShouldStop(8192);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 111;BA.debugLine="ToastMessageShow(\"No permission!\", True)";
Debug.ShouldStop(16384);
parent.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("No permission!")),(Object)(parent.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 112;BA.debugLine="VideoMode = False";
...
this.state = -1;
;
 BA.debugLineNum = 115;BA.debugLine="SetState(openstate, busystate, VideoMode)";
Debug.ShouldStop(262144);
_setstate(parent._openstate,parent._busystate,parent._videomode);
 BA.debugLineNum = 116;BA.debugLine="PrepareSurface";
...
try {
		Debug.PushSubsStack("btnRecord_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,119);
if (RapidSub.canDelegate("btnrecord_click")) { return b4a.example.actkamera.remoteMe.runUserSub(false, "actkamera","btnrecord_click");}
 BA.debugLineNum = 119;BA.debugLine="Sub btnRecord_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 120;BA.debugLine="If VideoMode Then";
Debug.ShouldStop(8388608);
if (actkamera._videomode.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 121;BA.debugLine="CaptureVideo";
Debug.ShouldStop(16777216);
_capturevideo();
 }else {
 BA.debugLineNum = 123;BA.debugLine="TakePicture";
Debug.ShouldStop(67108864);
_takepicture();
 };
...
try {
		Debug.PushSubsStack("CaptureVideo (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,128);
...
this.state = 4;
this.catchState = 11;
 BA.debugLineNum = 130;BA.debugLine="SetState(openstate, True, VideoMode)";
Debug.ShouldStop(2);
_setstate(parent._openstate,parent.mostCurrent.__c.getField(true,"True"),parent._videomode);
 BA.debugLineNum = 131;BA.debugLine="If cam.RecordingVideo = False Then";
Debug.ShouldStop(4);
if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 132;BA.debugLine="cam.StartVideoRecording (MyTaskIndex)";
Debug.ShouldStop(8);
...
//C
this.state = 9;
 BA.debugLineNum = 134;BA.debugLine="cam.StopVideoRecording (MyTaskIndex)";
Debug.ShouldStop(32);
parent.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_stopvideorecording" /*RemoteObject*/ ,(Object)(parent._mytaskindex));
 BA.debugLineNum = 135;BA.debugLine="File.Copy(VideoFileDir, \"temp-\" & VideoFileName";
Debug.ShouldStop(64);
parent.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(parent._videofiledir),(Object)(RemoteObject.concat(RemoteObject.createImmutable("temp-"),parent._videofilename)),(Object)(parent._videofiledir),(Object)(parent._videofilename));
 BA.debugLineNum = 136;BA.debugLine="ToastMessageShow($\"Video file saved: $1.2{File.";
Debug.ShouldStop(128);
parent.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence((RemoteObject.concat(RemoteObject.createImmutable("Video file saved: "),parent.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("1.2")),(Object)((RemoteObject.solve(new RemoteObject[] {parent.mostCurrent.__c.getField(false,"File").runMethod(true,"Size",(Object)(parent._videofiledir),(Object)(parent._videofilename)),RemoteObject.createImmutable(1024),RemoteObject.createImmutable(1024)}, "//",0, 0)))),RemoteObject.createImmutable(" MB"))))),(Object)(parent.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 137;BA.debugLine="Wait For (PrepareSurface) Complete (Success As";
Debug.ShouldStop(256);
...
;
 BA.debugLineNum = 138;BA.debugLine="SetState(openstate, False, VideoMode)";
Debug.ShouldStop(512);
...
this.state = 12;
this.catchState = 0;
 BA.debugLineNum = 142;BA.debugLine="HandleError(LastException)";
Debug.ShouldStop(8192);
...
public static RemoteObject  _globals() throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Private cam As CamEx2";
actkamera.mostCurrent._cam = RemoteObject.createNew ("b4a.example.camex2");
 //BA.debugLineNum = 23;BA.debugLine="Private pnlCamera As Panel";
...
actkamera.mostCurrent._imageview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");
 //BA.debugLineNum = 26;BA.debugLine="Private pnlBackground As Panel";
actkamera.mostCurrent._pnlbackground = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
 //BA.debugLineNum = 27;BA.debugLine="Private buttons As List";
actkamera.mostCurrent._buttons = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
 //BA.debugLineNum = 28;BA.debugLine="Private btnAutoExposure As Button";
...
try {
		Debug.PushSubsStack("HandleError (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,146);
...
Debug.locals.put("Error", _error);
 BA.debugLineNum = 146;BA.debugLine="Sub HandleError (Error As Exception)";
Debug.ShouldStop(131072);
 BA.debugLineNum = 147;BA.debugLine="Log(\"Error: \" & Error)";
Debug.ShouldStop(262144);
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","81507329",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_error),0);
 BA.debugLineNum = 148;BA.debugLine="ToastMessageShow(Error, True)";
Debug.ShouldStop(524288);
actkamera.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(_error.getObject())),(Object)(actkamera.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 149;BA.debugLine="OpenCamera(frontCamera)";
Debug.ShouldStop(1048576);
_opencamera(actkamera._frontcamera);
...
try {
		Debug.PushSubsStack("ImageView1_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,172);
if (RapidSub.canDelegate("imageview1_click")) { return b4a.example.actkamera.remoteMe.runUserSub(false, "actkamera","imageview1_click");}
RemoteObject _value = RemoteObject.declareNull("Object");
 BA.debugLineNum = 172;BA.debugLine="Sub ImageView1_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 173;BA.debugLine="pnlBackground.Visible = False";
Debug.ShouldStop(4096);
actkamera.mostCurrent._pnlbackground.runMethod(true,"setVisible",actkamera.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 175;BA.debugLine="Dim Value As Object";
Debug.ShouldStop(16384);
_value = RemoteObject.createNew ("Object");Debug.locals.put("Value", _value);
 BA.debugLineNum = 180;BA.debugLine="StartActivity(actLapor)";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("OpenCamera (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,59);
...
Debug.locals.put("front", _front);
 BA.debugLineNum = 60;BA.debugLine="rp.CheckAndRequest(rp.PERMISSION_CAMERA)";
Debug.ShouldStop(134217728);
...
//C
this.state = 4;
 BA.debugLineNum = 63;BA.debugLine="ToastMessageShow(\"No permission!\", True)";
Debug.ShouldStop(1073741824);
parent.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("No permission!")),(Object)(parent.mostCurrent.__c.getField(true,"True")));
...
this.state = 5;
;
 BA.debugLineNum = 67;BA.debugLine="SetState(False, False, VideoMode)";
Debug.ShouldStop(4);
_setstate(parent.mostCurrent.__c.getField(true,"False"),parent.mostCurrent.__c.getField(true,"False"),parent._videomode);
 BA.debugLineNum = 68;BA.debugLine="Wait For (cam.OpenCamera(front)) Complete (TaskIn";
Debug.ShouldStop(8);
...
;
 BA.debugLineNum = 69;BA.debugLine="If TaskIndex > 0 Then";
Debug.ShouldStop(16);
if (true) break;
...
//C
this.state = 8;
 BA.debugLineNum = 70;BA.debugLine="MyTaskIndex = TaskIndex 'hold this index. It wil";
Debug.ShouldStop(32);
parent._mytaskindex = _taskindex;
 BA.debugLineNum = 71;BA.debugLine="Wait For(PrepareSurface) Complete (Success As Bo";
Debug.ShouldStop(64);
...
this.state = 9;
;
 BA.debugLineNum = 73;BA.debugLine="Log(\"Start success: \" & Success)";
Debug.ShouldStop(256);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","81048590",RemoteObject.concat(RemoteObject.createImmutable("Start success: "),_success),0);
 BA.debugLineNum = 74;BA.debugLine="SetState(Success, False, VideoMode)";
Debug.ShouldStop(512);
...
//C
this.state = 12;
 BA.debugLineNum = 76;BA.debugLine="ToastMessageShow(\"Failed to open camera\", True)";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("PrepareSurface (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,80);
...
//C
this.state = 1;
 BA.debugLineNum = 81;BA.debugLine="SetState(False, busystate, VideoMode)";
Debug.ShouldStop(65536);
_setstate(parent.mostCurrent.__c.getField(true,"False"),parent._busystate,parent._videomode);
 BA.debugLineNum = 83;BA.debugLine="If VideoMode Then";
Debug.ShouldStop(262144);
if (true) break;
...
//C
this.state = 6;
 BA.debugLineNum = 84;BA.debugLine="cam.PreviewSize.Initialize(640, 480)";
Debug.ShouldStop(524288);
parent.mostCurrent._cam.getField(false,"_previewsize" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(BA.numberCast(int.class, 640)),(Object)(BA.numberCast(int.class, 480)));
 BA.debugLineNum = 86;BA.debugLine="Wait For (cam.PrepareSurfaceForVideo(MyTaskIndex";
Debug.ShouldStop(2097152);
...
//C
this.state = 6;
 BA.debugLineNum = 88;BA.debugLine="cam.PreviewSize.Initialize(1920, 1080)";
Debug.ShouldStop(8388608);
parent.mostCurrent._cam.getField(false,"_previewsize" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(BA.numberCast(int.class, 1920)),(Object)(BA.numberCast(int.class, 1080)));
 BA.debugLineNum = 89;BA.debugLine="Wait For (cam.PrepareSurface(MyTaskIndex)) Compl";
Debug.ShouldStop(16777216);
...
;
 if (true) break;
;
 BA.debugLineNum = 91;BA.debugLine="If Success Then cam.StartPreview(MyTaskIndex, Vid";
Debug.ShouldStop(67108864);
...
this.state = -1;
;
 BA.debugLineNum = 92;BA.debugLine="SetState(Success, busystate, VideoMode)";
Debug.ShouldStop(134217728);
_setstate(_success,parent._busystate,parent._videomode);
 BA.debugLineNum = 93;BA.debugLine="Return Success";
Debug.ShouldStop(268435456);
if (true) {
...
actkamera._sql1 = RemoteObject.createNew ("anywheresoftware.b4a.sql.SQL");
 //BA.debugLineNum = 15;BA.debugLine="Private  Cursor1 As Cursor";
actkamera._cursor1 = RemoteObject.createNew ("anywheresoftware.b4a.sql.SQL.CursorWrapper");
 //BA.debugLineNum = 17;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _setstate(RemoteObject _open,RemoteObject _busy,RemoteObject _video) throws Exception{
try {
		Debug.PushSubsStack("SetState (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,193);
...
Debug.locals.put("Video", _video);
 BA.debugLineNum = 193;BA.debugLine="Sub SetState(Open As Boolean, Busy As Boolean, Vid";
Debug.ShouldStop(1);
 BA.debugLineNum = 194;BA.debugLine="For Each b As Button In buttons";
Debug.ShouldStop(2);
...
Debug.locals.put("b", _b);
 BA.debugLineNum = 195;BA.debugLine="b.Visible = Open And Not(Busy)";
Debug.ShouldStop(4);
...
;
 BA.debugLineNum = 197;BA.debugLine="btnCamera.Visible = Not(Busy)";
Debug.ShouldStop(16);
actkamera.mostCurrent._btncamera.runMethod(true,"setVisible",actkamera.mostCurrent.__c.runMethod(true,"Not",(Object)(_busy)));
 BA.debugLineNum = 198;BA.debugLine="btnRecord.Visible = Open And (Video Or Not(Busy))";
Debug.ShouldStop(32);
actkamera.mostCurrent._btnrecord.runMethod(true,"setVisible",BA.ObjectToBoolean(RemoteObject.solveBoolean(".",_open) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",_video) || RemoteObject.solveBoolean(".",actkamera.mostCurrent.__c.runMethod(true,"Not",(Object)(_busy))))))));
 BA.debugLineNum = 199;BA.debugLine="openstate = Open";
Debug.ShouldStop(64);
actkamera._openstate = _open;
 BA.debugLineNum = 200;BA.debugLine="ProgressBar1.Visible = Busy";
Debug.ShouldStop(128);
actkamera.mostCurrent._progressbar1.runMethod(true,"setVisible",_busy);
 BA.debugLineNum = 201;BA.debugLine="busystate = Busy";
Debug.ShouldStop(256);
actkamera._busystate = _busy;
 BA.debugLineNum = 202;BA.debugLine="VideoMode = Video";
Debug.ShouldStop(512);
actkamera._videomode = _video;
 BA.debugLineNum = 203;BA.debugLine="barZoom.Visible = Open";
Debug.ShouldStop(1024);
actkamera.mostCurrent._barzoom.runMethod(true,"setVisible",_open);
 BA.debugLineNum = 204;BA.debugLine="Dim btnRecordText As String";
Debug.ShouldStop(2048);
_btnrecordtext = RemoteObject.createImmutable("");Debug.locals.put("btnRecordText", _btnrecordtext);
 BA.debugLineNum = 205;BA.debugLine="If VideoMode Then";
Debug.ShouldStop(4096);
if (actkamera._videomode.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 206;BA.debugLine="If Busy Then";
Debug.ShouldStop(8192);
if (_busy.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 207;BA.debugLine="btnRecordText = Chr(0xF04D)";
Debug.ShouldStop(16384);
_btnrecordtext = BA.ObjectToString(actkamera.mostCurrent.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf04d))));Debug.locals.put("btnRecordText", _btnrecordtext);
 ...
 BA.debugLineNum = 209;BA.debugLine="btnRecordText = Chr(0xF03D)";
Debug.ShouldStop(65536);
_btnrecordtext = BA.ObjectToString(actkamera.mostCurrent.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf03d))));Debug.locals.put("btnRecordText", _btnrecordtext);
 ...
 BA.debugLineNum = 212;BA.debugLine="btnRecordText = Chr(0xF030)";
Debug.ShouldStop(524288);
_btnrecordtext = BA.ObjectToString(actkamera.mostCurrent.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf030))));Debug.locals.put("btnRecordText", _btnrecordtext);
 ...
 BA.debugLineNum = 214;BA.debugLine="btnRecord.Text = btnRecordText";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("TakePicture (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,152);
...
this.state = 6;
this.catchState = 5;
 BA.debugLineNum = 154;BA.debugLine="SetState(openstate, True, VideoMode)";
Debug.ShouldStop(33554432);
_setstate(parent._openstate,parent.mostCurrent.__c.getField(true,"True"),parent._videomode);
 BA.debugLineNum = 155;BA.debugLine="Wait For(cam.FocusAndTakePicture(MyTaskIndex)) C";
Debug.ShouldStop(67108864);
...
;
 BA.debugLineNum = 156;BA.debugLine="SetState(openstate, False, VideoMode)";
Debug.ShouldStop(134217728);
_setstate(parent._openstate,parent.mostCurrent.__c.getField(true,"False"),parent._videomode);
 BA.debugLineNum = 157;BA.debugLine="cam.DataToFile(Data, VideoFileDir, \"1.jpg\")";
Debug.ShouldStop(268435456);
parent.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_datatofile" /*RemoteObject*/ ,(Object)(_data),(Object)(parent._videofiledir),(Object)(RemoteObject.createImmutable("1.jpg")));
 BA.debugLineNum = 158;BA.debugLine="Dim bmp As Bitmap = cam.DataToBitmap(Data)";
Debug.ShouldStop(536870912);
...
_bmp = parent.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_datatobitmap" /*RemoteObject*/ ,(Object)(_data));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 159;BA.debugLine="Log(\"Picture taken: \" & bmp) 'ignore";
Debug.ShouldStop(1073741824);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","81572871",RemoteObject.concat(RemoteObject.createImmutable("Picture taken: "),_bmp),0);
 BA.debugLineNum = 160;BA.debugLine="pnlBackground.SetVisibleAnimated(100, True)";
Debug.ShouldStop(-2147483648);
parent.mostCurrent._pnlbackground.runVoidMethod ("SetVisibleAnimated",(Object)(BA.numberCast(int.class, 100)),(Object)(parent.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 161;BA.debugLine="ImageView1.SetBackgroundImage(bmp.Resize(ImageVi";
Debug.ShouldStop(1);
parent.mostCurrent._imageview1.runMethod(false,"SetBackgroundImageNew",(Object)((_bmp.runMethod(false,"Resize",(Object)(BA.numberCast(float.class, parent.mostCurrent._imageview1.runMethod(true,"getWidth"))),(Object)(BA.numberCast(float.class, parent.mostCurrent._imageview1.runMethod(true,"getHeight"))),(Object)(parent.mostCurrent.__c.getField(true,"True"))).getObject()))).runMethod(true,"setGravity",parent.mostCurrent.__c.getField(false,"Gravity").getField(true,"CENTER"));
 BA.debugLineNum = 162;BA.debugLine="Sleep(4000)";
Debug.ShouldStop(2);
...
this.state = 6;
;
 BA.debugLineNum = 163;BA.debugLine="pnlBackground.SetVisibleAnimated(500, False)";
Debug.ShouldStop(4);
...
this.state = 6;
this.catchState = 0;
 BA.debugLineNum = 165;BA.debugLine="HandleError(LastException)";
Debug.ShouldStop(16);
_handleerror(parent.mostCurrent.__c.runMethod(false,"LastException",actkamera.mostCurrent.activityBA));
 if (true) break;
if (true) break;
