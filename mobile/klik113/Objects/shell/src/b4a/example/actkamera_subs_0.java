...
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","2917512",actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getsupportedhardwarelevel" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(262144);
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","21507329",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_error),0);
...
Debug.ShouldStop(256);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","21048590",RemoteObject.concat(RemoteObject.createImmutable("Start success: "),_success),0);
...
Debug.ShouldStop(1073741824);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","21572871",RemoteObject.concat(RemoteObject.createImmutable("Picture taken: "),_bmp),0);
