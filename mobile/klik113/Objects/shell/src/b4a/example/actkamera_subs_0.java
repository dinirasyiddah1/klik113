...
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","5917512",actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getsupportedhardwarelevel" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("Activity_Pause (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,95);
...
try {
		Debug.PushSubsStack("Activity_Resume (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,49);
...
try {
		Debug.PushSubsStack("barZoom_ValueChanged (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,203);
...
Debug.locals.put("UserChanged", _userchanged);
 BA.debugLineNum = 203;BA.debugLine="Sub barZoom_ValueChanged (Value As Int, UserChange";
Debug.ShouldStop(1024);
 BA.debugLineNum = 204;BA.debugLine="Dim OriginalSize As Rect = cam.ActiveArraySize";
Debug.ShouldStop(2048);
...
_originalsize = actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getactivearraysize" /*RemoteObject*/ );Debug.locals.put("OriginalSize", _originalsize);Debug.locals.put("OriginalSize", _originalsize);
 BA.debugLineNum = 205;BA.debugLine="Dim Zoom As Float = 1 + Value / 100 * (cam.MaxDig";
Debug.ShouldStop(4096);
_zoom = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(1),_value,RemoteObject.createImmutable(100),(RemoteObject.solve(new RemoteObject[] {actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getmaxdigitalzoom" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "-",1, 0))}, "+/*",1, 0));Debug.locals.put("Zoom", _zoom);Debug.locals.put("Zoom", _zoom);
 BA.debugLineNum = 206;BA.debugLine="Dim Crop As Rect";
...
_crop = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper");Debug.locals.put("Crop", _crop);
 BA.debugLineNum = 207;BA.debugLine="Dim NewWidth As Int = OriginalSize.Width / Zoom";
Debug.ShouldStop(16384);
_newwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getWidth"),_zoom}, "/",0, 0));Debug.locals.put("NewWidth", _newwidth);Debug.locals.put("NewWidth", _newwidth);
 BA.debugLineNum = 208;BA.debugLine="Dim NewHeight As Int = OriginalSize.Height / Zoom";
...
_newheight = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getHeight"),_zoom}, "/",0, 0));Debug.locals.put("NewHeight", _newheight);Debug.locals.put("NewHeight", _newheight);
 BA.debugLineNum = 209;BA.debugLine="Crop.Initialize(OriginalSize.CenterX - NewWidth /";
Debug.ShouldStop(65536);
_crop.runVoidMethod ("Initialize",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterX"),_newwidth,RemoteObject.createImmutable(2)}, "-/",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterY"),_newheight,RemoteObject.createImmutable(2)}, "-/",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterX"),_newwidth,RemoteObject.createImmutable(2)}, "+/",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_originalsize.runMethod(true,"getCenterY"),_newheight,RemoteObject.createImmutable(2)}, "+/",1, 0))));
 BA.debugLineNum = 211;BA.debugLine="cam.PreviewCropRegion = Crop";
Debug.ShouldStop(262144);
actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_setpreviewcropregion",_crop);
 BA.debugLineNum = 212;BA.debugLine="cam.StartPreview(MyTaskIndex, VideoMode)";
...
try {
		Debug.PushSubsStack("btnAutoExposure_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,169);
...
RemoteObject _i = RemoteObject.createImmutable(0);
 BA.debugLineNum = 169;BA.debugLine="Sub btnAutoExposure_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 170;BA.debugLine="Dim flashes As List = cam.SupportedAutoExposureMo";
Debug.ShouldStop(512);
...
_flashes = actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getsupportedautoexposuremodes" /*RemoteObject*/ );Debug.locals.put("flashes", _flashes);Debug.locals.put("flashes", _flashes);
 BA.debugLineNum = 171;BA.debugLine="Dim i As Int = flashes.IndexOf(cam.AutoExposureMo";
Debug.ShouldStop(1024);
_i = _flashes.runMethod(true,"IndexOf",(Object)((actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getautoexposuremode" /*RemoteObject*/ ))));Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 172;BA.debugLine="i = (i + 1) Mod flashes.Size";
Debug.ShouldStop(2048);
_i = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1)),_flashes.runMethod(true,"getSize")}, "%",0, 1);Debug.locals.put("i", _i);
 BA.debugLineNum = 173;BA.debugLine="cam.AutoExposureMode = flashes.Get(i)";
Debug.ShouldStop(4096);
actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_setautoexposuremode" /*RemoteObject*/ ,BA.ObjectToString(_flashes.runMethod(false,"Get",(Object)(_i))));
 BA.debugLineNum = 174;BA.debugLine="btnAutoExposure.Text = flashes.Get(i)";
Debug.ShouldStop(8192);
actkamera.mostCurrent._btnautoexposure.runMethod(true,"setText",BA.ObjectToCharSequence(_flashes.runMethod(false,"Get",(Object)(_i))));
 BA.debugLineNum = 175;BA.debugLine="cam.StartPreview(MyTaskIndex, VideoMode)";
Debug.ShouldStop(16384);
actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_startpreview" /*RemoteObject*/ ,(Object)(actkamera._mytaskindex),(Object)(actkamera._videomode));
...
try {
		Debug.PushSubsStack("btnCamera_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,90);
...
try {
		Debug.PushSubsStack("btnMode_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,99);
...
try {
		Debug.PushSubsStack("btnRecord_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,113);
...
try {
		Debug.PushSubsStack("CaptureVideo (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,122);
...
try {
		Debug.PushSubsStack("HandleError (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,140);
...
Debug.ShouldStop(4096);
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","51507329",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_error),0);
...
try {
		Debug.PushSubsStack("OpenCamera (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,53);
...
Debug.ShouldStop(4);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","51048590",RemoteObject.concat(RemoteObject.createImmutable("Start success: "),_success),0);
...
try {
		Debug.PushSubsStack("pnlPicture_Click (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,164);
if (RapidSub.canDelegate("pnlpicture_click")) { return b4a.example.actkamera.remoteMe.runUserSub(false, "actkamera","pnlpicture_click");}
 BA.debugLineNum = 164;BA.debugLine="Sub pnlPicture_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 165;BA.debugLine="pnlBackground.Visible = False";
Debug.ShouldStop(16);
actkamera.mostCurrent._pnlbackground.runMethod(true,"setVisible",actkamera.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 166;BA.debugLine="StartActivity(actLapor)";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("PrepareSurface (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,74);
...
try {
		Debug.PushSubsStack("SetState (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,179);
...
Debug.locals.put("Video", _video);
 BA.debugLineNum = 179;BA.debugLine="Sub SetState(Open As Boolean, Busy As Boolean, Vid";
Debug.ShouldStop(262144);
 BA.debugLineNum = 180;BA.debugLine="For Each b As Button In buttons";
Debug.ShouldStop(524288);
...
Debug.locals.put("b", _b);
 BA.debugLineNum = 181;BA.debugLine="b.Visible = Open And Not(Busy)";
Debug.ShouldStop(1048576);
...
;
 BA.debugLineNum = 183;BA.debugLine="btnCamera.Visible = Not(Busy)";
Debug.ShouldStop(4194304);
actkamera.mostCurrent._btncamera.runMethod(true,"setVisible",actkamera.mostCurrent.__c.runMethod(true,"Not",(Object)(_busy)));
 BA.debugLineNum = 184;BA.debugLine="btnRecord.Visible = Open And (Video Or Not(Busy))";
Debug.ShouldStop(8388608);
actkamera.mostCurrent._btnrecord.runMethod(true,"setVisible",BA.ObjectToBoolean(RemoteObject.solveBoolean(".",_open) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",_video) || RemoteObject.solveBoolean(".",actkamera.mostCurrent.__c.runMethod(true,"Not",(Object)(_busy))))))));
 BA.debugLineNum = 185;BA.debugLine="openstate = Open";
Debug.ShouldStop(16777216);
actkamera._openstate = _open;
 BA.debugLineNum = 186;BA.debugLine="ProgressBar1.Visible = Busy";
Debug.ShouldStop(33554432);
actkamera.mostCurrent._progressbar1.runMethod(true,"setVisible",_busy);
 BA.debugLineNum = 187;BA.debugLine="busystate = Busy";
Debug.ShouldStop(67108864);
actkamera._busystate = _busy;
 BA.debugLineNum = 188;BA.debugLine="VideoMode = Video";
Debug.ShouldStop(134217728);
actkamera._videomode = _video;
 BA.debugLineNum = 189;BA.debugLine="barZoom.Visible = Open";
Debug.ShouldStop(268435456);
actkamera.mostCurrent._barzoom.runMethod(true,"setVisible",_open);
 BA.debugLineNum = 190;BA.debugLine="Dim btnRecordText As String";
Debug.ShouldStop(536870912);
_btnrecordtext = RemoteObject.createImmutable("");Debug.locals.put("btnRecordText", _btnrecordtext);
 BA.debugLineNum = 191;BA.debugLine="If VideoMode Then";
Debug.ShouldStop(1073741824);
if (actkamera._videomode.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 192;BA.debugLine="If Busy Then";
Debug.ShouldStop(-2147483648);
if (_busy.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 193;BA.debugLine="btnRecordText = Chr(0xF04D)";
Debug.ShouldStop(1);
_btnrecordtext = BA.ObjectToString(actkamera.mostCurrent.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf04d))));Debug.locals.put("btnRecordText", _btnrecordtext);
 ...
 BA.debugLineNum = 195;BA.debugLine="btnRecordText = Chr(0xF03D)";
Debug.ShouldStop(4);
_btnrecordtext = BA.ObjectToString(actkamera.mostCurrent.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf03d))));Debug.locals.put("btnRecordText", _btnrecordtext);
 ...
 BA.debugLineNum = 198;BA.debugLine="btnRecordText = Chr(0xF030)";
Debug.ShouldStop(32);
_btnrecordtext = BA.ObjectToString(actkamera.mostCurrent.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf030))));Debug.locals.put("btnRecordText", _btnrecordtext);
 ...
 BA.debugLineNum = 200;BA.debugLine="btnRecord.Text = btnRecordText";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("TakePicture (actkamera) ","actkamera",2,actkamera.mostCurrent.activityBA,actkamera.mostCurrent,146);
...
Debug.ShouldStop(2097152);
_setstate(parent._openstate,parent.mostCurrent.__c.getField(true,"False"),parent._videomode);
 BA.debugLineNum = 151;BA.debugLine="cam.DataToFile(Data, VideoFileDir, \"1.jpg\")";
Debug.ShouldStop(4194304);
parent.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_datatofile" /*RemoteObject*/ ,(Object)(_data),(Object)(parent._videofiledir),(Object)(RemoteObject.createImmutable("1.jpg")));
 BA.debugLineNum = 152;BA.debugLine="Dim bmp As Bitmap = cam.DataToBitmap(Data)";
Debug.ShouldStop(8388608);
...
_bmp = parent.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_datatobitmap" /*RemoteObject*/ ,(Object)(_data));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 153;BA.debugLine="Log(\"Picture taken: \" & bmp) 'ignore";
Debug.ShouldStop(16777216);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","51572871",RemoteObject.concat(RemoteObject.createImmutable("Picture taken: "),_bmp),0);
 BA.debugLineNum = 154;BA.debugLine="pnlBackground.SetVisibleAnimated(100, True)";
Debug.ShouldStop(33554432);
parent.mostCurrent._pnlbackground.runVoidMethod ("SetVisibleAnimated",(Object)(BA.numberCast(int.class, 100)),(Object)(parent.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 155;BA.debugLine="pnlPicture.SetBackgroundImage(bmp.Resize(pnlPict";
Debug.ShouldStop(67108864);
...
this.state = 6;
;
 BA.debugLineNum = 157;BA.debugLine="pnlBackground.SetVisibleAnimated(500, False)";
Debug.ShouldStop(268435456);
...
this.state = 6;
this.catchState = 0;
 BA.debugLineNum = 159;BA.debugLine="HandleError(LastException)";
Debug.ShouldStop(1073741824);
_handleerror(parent.mostCurrent.__c.runMethod(false,"LastException",actkamera.mostCurrent.activityBA));
 if (true) break;
if (true) break;
