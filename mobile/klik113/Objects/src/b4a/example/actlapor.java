...
RDebugUtils.currentLine=5636099;
 //BA.debugLineNum = 5636099;BA.debugLine="viewPicture";
_viewpicture();
RDebugUtils.currentLine=5636101;
 //BA.debugLineNum = 5636101;BA.debugLine="End Sub";
return "";
}
public static String  _viewpicture() throws Exception{
RDebugUtils.currentModule="actlapor";
if (Debug.shouldDelegate(mostCurrent.activityBA, "viewpicture", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "viewpicture", null));}
RDebugUtils.currentLine=5898240;
 //BA.debugLineNum = 5898240;BA.debugLine="Sub viewPicture";
RDebugUtils.currentLine=5898241;
 //BA.debugLineNum = 5898241;BA.debugLine="pnlPicture.SetBackgroundImage(bmp.Resize(pnlPict";
mostCurrent._pnlpicture.SetBackgroundImageNew((android.graphics.Bitmap)(mostCurrent._bmp.Resize((float) (mostCurrent._pnlpicture.getWidth()),(float) (mostCurrent._pnlpicture.getHeight()),anywheresoftware.b4a.keywords.Common.True).getObject())).setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
