...
vis = vis | (actcam.mostCurrent != null);
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, starter.class));
 ...
 {
            Activity __a = null;
            if (actlapor.previousOne != null) {
				__a = actlapor.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(actlapor.mostCurrent == null ? null : actlapor.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, srvgps.class));
 {
            Activity __a = null;
            if (actcam.previousOne != null) {
				__a = actcam.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(actcam.mostCurrent == null ? null : actcam.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
RDebugUtils.currentLine=131075;
 //BA.debugLineNum = 131075;BA.debugLine="Button1.Visible=False";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=131076;
 //BA.debugLineNum = 131076;BA.debugLine="WebView1.LoadUrl(\"http://369dbe9d93aa.ngrok.io/kl";
mostCurrent._webview1.LoadUrl("http://369dbe9d93aa.ngrok.io/klik113-master/mobile/incident_today.php");
RDebugUtils.currentLine=131077;
 //BA.debugLineNum = 131077;BA.debugLine="Panel1.Visible=True ' put panel1 visible";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=131079;
 //BA.debugLineNum = 131079;BA.debugLine="Panel1.BringToFront ' if some control is visible";
mostCurrent._panel1.BringToFront();
RDebugUtils.currentLine=131080;
 //BA.debugLineNum = 131080;BA.debugLine="Panel1.SetLayout((Activity.Width - Panel1.Width)";
mostCurrent._panel1.SetLayout((int) ((mostCurrent._activity.getWidth()-mostCurrent._panel1.getWidth())/(double)2),(int) ((mostCurrent._activity.getHeight()-mostCurrent._panel1.getHeight())/(double)2),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (256)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (256)));
RDebugUtils.currentLine=131082;
 //BA.debugLineNum = 131082;BA.debugLine="Timer1.Initialize(\"Timer1\", 3000) ' start timer1";
_timer1.Initialize(processBA,"Timer1",(long) (3000));
RDebugUtils.currentLine=131083;
 //BA.debugLineNum = 131083;BA.debugLine="Timer1.Enabled=True";
...
RDebugUtils.currentLine=786433;
 //BA.debugLineNum = 786433;BA.debugLine="StartActivity(actKamera)";
...
RDebugUtils.currentLine=720898;
 //BA.debugLineNum = 720898;BA.debugLine="Panel1.Visible=False";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=720899;
 //BA.debugLineNum = 720899;BA.debugLine="Panel3.Visible=False";
mostCurrent._panel3.setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=720900;
 //BA.debugLineNum = 720900;BA.debugLine="Timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=720901;
 //BA.debugLineNum = 720901;BA.debugLine="Button1.Visible=True";
