...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"actCam",Debug.moduleToString(b4a.example.actcam.class),"Activity",actlapor.mostCurrent._activity,"actKamera",Debug.moduleToString(b4a.example.actkamera.class),"address",actlapor.mostCurrent._address,"btnLapor",actlapor.mostCurrent._btnlapor,"EditLat",actlapor.mostCurrent._editlat,"EditLon",actlapor.mostCurrent._editlon,"gps",Debug.moduleToString(b4a.example.gps.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"lblLat",actlapor.mostCurrent._lbllat,"lblLon",actlapor.mostCurrent._lbllon,"Main",Debug.moduleToString(b4a.example.main.class),"name",actlapor.mostCurrent._name,"phone",actlapor.mostCurrent._phone,"pnlBg",actlapor.mostCurrent._pnlbg,"pnlFile",actlapor.mostCurrent._pnlfile,"rp",actlapor._rp,"server",actlapor._server,"srvGPS",Debug.moduleToString(b4a.example.srvgps.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}