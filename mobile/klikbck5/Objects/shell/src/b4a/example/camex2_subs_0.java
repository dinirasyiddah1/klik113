...
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","16684676",RemoteObject.createImmutable("Focus not supported"),0);
 if (true) break;
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","16684684",RemoteObject.createImmutable("Focus failed"),0);
 if (true) break;
...
parent.__c.runVoidMethod ("LogImpl","16684686",RemoteObject.createImmutable("Focused!"),0);
 if (true) break;
...
Debug.ShouldStop(32);
camex2.__c.runVoidMethod ("LogImpl","17536649",BA.ObjectToString(_consts),0);
 BA.debugLineNum = 423;BA.debugLine="Log(\"Unknown consts: \" & mode)";
Debug.ShouldStop(64);
camex2.__c.runVoidMethod ("LogImpl","17536650",RemoteObject.concat(RemoteObject.createImmutable("Unknown consts: "),_mode),0);
 };
 }
}Debug.locals.put("mode", _mode);
;
...
Debug.ShouldStop(4194304);
camex2.__c.runVoidMethod ("LogImpl","17471110",BA.ObjectToString(_consts),0);
 BA.debugLineNum = 408;BA.debugLine="Log(\"Unknown const: \" & i)";
Debug.ShouldStop(8388608);
camex2.__c.runVoidMethod ("LogImpl","17471111",RemoteObject.concat(RemoteObject.createImmutable("Unknown const: "),_i),0);
...
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","14653064",RemoteObject.createImmutable("Camera not found."),0);
...
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","14653070",RemoteObject.createImmutable("Failed to open camera"),0);
...
Debug.ShouldStop(268435456);
camex2.__c.runVoidMethod ("LogImpl","17733249",(RemoteObject.concat(RemoteObject.createImmutable("******  "),camex2.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_title))),RemoteObject.createImmutable(" **********"))),0);
...
Debug.ShouldStop(16384);
camex2.__c.runVoidMethod ("LogImpl","17733267",(RemoteObject.concat(RemoteObject.createImmutable(""),camex2.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)(_k.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getName")),(Object)((camex2.__c.getField(false,"Null")))))),RemoteObject.createImmutable(": "),camex2.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)(_value)),RemoteObject.createImmutable(""))),0);
 }
}Debug.locals.put("k", _k);
;
...
Debug.ShouldStop(512);
camex2.__c.runVoidMethod ("LogImpl","15111813",BA.ObjectToString(camex2.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
