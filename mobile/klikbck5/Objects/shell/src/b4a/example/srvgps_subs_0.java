...
try {
		Debug.PushSubsStack("Application_Error (srvgps) ","srvgps",4,srvgps.processBA,srvgps.mostCurrent,40);
...
try {
		Debug.PushSubsStack("GPS_LocationChanged (srvgps) ","srvgps",4,srvgps.processBA,srvgps.mostCurrent,34);
...
try {
		Debug.PushSubsStack("Service_Create (srvgps) ","srvgps",4,srvgps.processBA,srvgps.mostCurrent,12);
...
try {
		Debug.PushSubsStack("Service_Destroy (srvgps) ","srvgps",4,srvgps.processBA,srvgps.mostCurrent,44);
...
try {
		Debug.PushSubsStack("Service_Start (srvgps) ","srvgps",4,srvgps.processBA,srvgps.mostCurrent,16);
...
try {
		Debug.PushSubsStack("StartGps (srvgps) ","srvgps",4,srvgps.processBA,srvgps.mostCurrent,20);
...
try {
		Debug.PushSubsStack("StopGps (srvgps) ","srvgps",4,srvgps.processBA,srvgps.mostCurrent,27);
