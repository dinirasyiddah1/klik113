...
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","8983048",actkamera.mostCurrent._cam.runClassMethod (b4a.example.camex2.class, "_getsupportedhardwarelevel" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(16384);
actkamera.mostCurrent.__c.runVoidMethod ("LogImpl","81572865",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_error),0);
...
Debug.ShouldStop(16);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","81114126",RemoteObject.concat(RemoteObject.createImmutable("Start success: "),_success),0);
...
Debug.ShouldStop(256);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","81638421",RemoteObject.concat(RemoteObject.createImmutable("Picture taken: "),_bmp),0);
...
Debug.ShouldStop(8192);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","81638426",parent.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirDefaultExternal"),0);
 Debug.CheckDeviceExceptions();
if (true) break;
