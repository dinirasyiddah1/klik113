...
Debug.ShouldStop(67108864);
 BA.debugLineNum = 28;BA.debugLine="Log(\"Application_Error\")";
Debug.ShouldStop(134217728);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","45177345",RemoteObject.createImmutable("Application_Error"),0);
 BA.debugLineNum = 29;BA.debugLine="Log(Error)";
Debug.ShouldStop(268435456);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","45177346",BA.ObjectToString(_error),0);
 BA.debugLineNum = 30;BA.debugLine="Log(StackTrace)";
Debug.ShouldStop(536870912);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","45177347",_stacktrace,0);
...
try {
		Debug.PushSubsStack("Service_Destroy (starter) ","starter",2,starter.processBA,starter.mostCurrent,34);
...
if (RapidSub.canDelegate("service_taskremoved")) { return b4a.example3.starter.remoteMe.runUserSub(false, "starter","service_taskremoved");}
