...
public static RemoteObject _cam = RemoteObject.declareNull("b4a.example3.camex2");
...
public static b4a.example3.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"barZoom",main.mostCurrent._barzoom,"btnAutoExposure",main.mostCurrent._btnautoexposure,"btnCamera",main.mostCurrent._btncamera,"btnEffects",main.mostCurrent._btneffects,"btnFocus",main.mostCurrent._btnfocus,"btnMode",main.mostCurrent._btnmode,"btnRecord",main.mostCurrent._btnrecord,"btnScene",main.mostCurrent._btnscene,"busystate",main._busystate,"buttons",main.mostCurrent._buttons,"cam",main.mostCurrent._cam,"frontCamera",main._frontcamera,"MyTaskIndex",main._mytaskindex,"openstate",main._openstate,"pnlBackground",main.mostCurrent._pnlbackground,"pnlCamera",main.mostCurrent._pnlcamera,"pnlPicture",main.mostCurrent._pnlpicture,"ProgressBar1",main.mostCurrent._progressbar1,"rp",main._rp,"Starter",Debug.moduleToString(b4a.example3.starter.class),"VideoFileDir",main._videofiledir,"VideoFileName",main._videofilename,"VideoMode",main._videomode};
}
}