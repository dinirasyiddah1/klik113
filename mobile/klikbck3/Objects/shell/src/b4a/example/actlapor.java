...
public static b4a.example.gps _gps = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",actlapor.mostCurrent._activity,"actKamera",Debug.moduleToString(b4a.example.actkamera.class),"gps",Debug.moduleToString(b4a.example.gps.class),"lblLat",actlapor.mostCurrent._lbllat,"lblLon",actlapor.mostCurrent._lbllon,"Main",Debug.moduleToString(b4a.example.main.class),"srvGPS",Debug.moduleToString(b4a.example.srvgps.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}