...
RDebugUtils.currentLine=5701642;
 //BA.debugLineNum = 5701642;BA.debugLine="Dim dir As String = File.DirDefaultExternal";
_dir = anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal();
RDebugUtils.currentLine=5701643;
 //BA.debugLineNum = 5701643;BA.debugLine="Dim media As String = \"1.jpg\"";
_media = "1.jpg";
...
RDebugUtils.currentLine=5701647;
 //BA.debugLineNum = 5701647;BA.debugLine="b.Initialize(LoadBitmap(dir, media))";
...
RDebugUtils.currentLine=5701653;
 //BA.debugLineNum = 5701653;BA.debugLine="Activity.AddView(iView,10%x, 50dip, 80%x, 30%y)";
...
RDebugUtils.currentLine=5701655;
 //BA.debugLineNum = 5701655;BA.debugLine="iView.Bitmap=LoadBitmap(dir, media)";
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094851",_lokasi,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094855",_nama_orang,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094859",_no_hp,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094863",BA.NumberToString(_lat),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094867",BA.NumberToString(_lon),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094871",_tanggal,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094876",_jam,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56094880",BA.NumberToString(_id_kejadian),0);
RDebugUtils.currentLine=6094882;
 //BA.debugLineNum = 6094882;BA.debugLine="Dim media As String = \"1.jpg\"";
_media = "1.jpg";
RDebugUtils.currentLine=6094884;
 //BA.debugLineNum = 6094884;BA.debugLine="Dim Job1 As HttpJob";
_job1 = new b4a.example.httpjob();
RDebugUtils.currentLine=6094885;
 //BA.debugLineNum = 6094885;BA.debugLine="Job1.Initialize(\"Job1\",Me)";
_job1._initialize /*String*/ (null,processBA,"Job1",actlapor.getObject());
RDebugUtils.currentLine=6094886;
 //BA.debugLineNum = 6094886;BA.debugLine="Job1.PostString(\"\"&server&\"laporkan1.php\",\"&nama_";
_job1._poststring /*String*/ (null,""+_server+"laporkan1.php","&nama_orang="+_nama_orang+"&lokasi="+_lokasi+"&no_hp="+_no_hp+"&tanggal="+_tanggal+"&media="+_media+"&jam="+_jam+"&lat="+BA.NumberToString(_lat)+"&lon="+BA.NumberToString(_lon)+"&id_kejadian="+BA.NumberToString(_id_kejadian));
RDebugUtils.currentLine=6094888;
 //BA.debugLineNum = 6094888;BA.debugLine="End Sub";
return "";
}
...
anywheresoftware.b4a.keywords.Common.LogImpl("56160385","JobName = "+_job1._jobname /*String*/ +", Success = "+BA.ObjectToString(_job1._success /*boolean*/ ),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56160390","behasil",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56160397","Error: "+_job1._errormessage /*String*/ ,0);
