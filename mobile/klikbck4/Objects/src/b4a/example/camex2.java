...
__c.LogImpl("52555909",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("52097160","Camera not found.",0);
...
parent.__c.LogImpl("52097166","Failed to open camera",0);
...
parent.__c.LogImpl("54128772","Focus not supported",0);
 if (true) break;
...
parent.__c.LogImpl("54128780","Focus failed",0);
 if (true) break;
...
parent.__c.LogImpl("54128782","Focused!",0);
 if (true) break;
...
__c.LogImpl("54915206",BA.ObjectToString(_consts),0);
RDebugUtils.currentLine=4915207;
 //BA.debugLineNum = 4915207;BA.debugLine="Log(\"Unknown const: \" & i)";
__c.LogImpl("54915207","Unknown const: "+BA.NumberToString(_i),0);
...
__c.LogImpl("54980745",BA.ObjectToString(_consts),0);
RDebugUtils.currentLine=4980746;
 //BA.debugLineNum = 4980746;BA.debugLine="Log(\"Unknown consts: \" & mode)";
__c.LogImpl("54980746","Unknown consts: "+BA.NumberToString(_mode),0);
 };
 }
};
...
__c.LogImpl("55177345",("******  "+__c.SmartStringFormatter("",(Object)(_title))+" **********"),0);
...
__c.LogImpl("55177363",(""+__c.SmartStringFormatter("",_k.RunMethod("getName",(Object[])(__c.Null)))+": "+__c.SmartStringFormatter("",_value)+""),0);
 }
};
