...
try {
		Debug.PushSubsStack("Activity_Pause (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,66);
...
try {
		Debug.PushSubsStack("Activity_Resume (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,60);
...
try {
		Debug.PushSubsStack("btnLapor_Click (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,88);
...
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094851",_lokasi,0);
...
Debug.ShouldStop(1073741824);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094855",_nama_orang,0);
...
Debug.ShouldStop(4);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094859",_no_hp,0);
...
Debug.ShouldStop(64);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094863",BA.NumberToString(_lat),0);
...
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094867",BA.NumberToString(_lon),0);
...
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094871",_tanggal,0);
...
Debug.ShouldStop(524288);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094876",_jam,0);
...
Debug.ShouldStop(8388608);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56094880",BA.NumberToString(_id_kejadian),0);
...
_job1.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,actlapor.processBA,(Object)(BA.ObjectToString("Job1")),(Object)(actlapor.getObject()));
 BA.debugLineNum = 126;BA.debugLine="Job1.PostString(\"\"&server&\"laporkan1.php\",\"&nama_";
Debug.ShouldStop(536870912);
_job1.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable(""),actlapor._server,RemoteObject.createImmutable("laporkan1.php"))),(Object)(RemoteObject.concat(RemoteObject.createImmutable("&nama_orang="),_nama_orang,RemoteObject.createImmutable("&lokasi="),_lokasi,RemoteObject.createImmutable("&no_hp="),_no_hp,RemoteObject.createImmutable("&tanggal="),_tanggal,RemoteObject.createImmutable("&media="),_media,RemoteObject.createImmutable("&jam="),_jam,RemoteObject.createImmutable("&lat="),_lat,RemoteObject.createImmutable("&lon="),_lon,RemoteObject.createImmutable("&id_kejadian="),_id_kejadian)));
...
try {
		Debug.PushSubsStack("ExecuteRemoteQuery (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,81);
...
try {
		Debug.PushSubsStack("id_laporan (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,77);
...
try {
		Debug.PushSubsStack("JobDone (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,130);
...
Debug.ShouldStop(4);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56160385",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job1.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job1.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(128);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56160390",RemoteObject.createImmutable("behasil"),0);
...
Debug.ShouldStop(16384);
actlapor.mostCurrent.__c.runVoidMethod ("LogImpl","56160397",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job1.getField(true,"_errormessage" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("Label4_Click (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,151);
...
try {
		Debug.PushSubsStack("LocationChanged (actlapor) ","actlapor",4,actlapor.mostCurrent.activityBA,actlapor.mostCurrent,72);
...
public static RemoteObject  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Dim server =\"http://b240bd05c3dc.ngrok.io/klik113";
