...
<div id="showPeople" class="modal fade" role="dialog">
  ...
  <button type="button" name="People2"  class="btn btn-warning btn-sm" data-toggle='modal'  data-target='#addOrang'> Add New</button>
  <br><br>
...
include "connect.php";
 ...
 ?>
    <tr>
      ...
      <td><?=$hasil['no_hp'];?></td>
      <td><button type="button" name="People2"  id="edit<?=$hasil['id_orang'];?>" class="btn btn-info btn-sm edit" data-toggle='modal'  data-target='#showPeople2'> Detail</button>  
      </td>
    </tr>
  <?php $no++; }; ?>
</table>
...
<div id="addOrang" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="dropdown">
                    <label for="suku"><span style="color:red">*</span>mobile phone</label><br>
...
<div id="showPeople2" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" id="form_people" class="ajax">
            <div class="alert alert-warning js-alert hidden" role="alert">
              <button type="button" id="" class="close" data-dismiss="alert">&times;</button>
              <strong>EDIT</strong> Sukses Ubah Data!
            </div>
             <div class="alert alert-danger js-alert hidden" role="alert">
              <button type="button" id="" class="close" data-dismiss="alert">&times;</button>
              <strong>DELETE</strong> Berhasil Hapus Data!
            </div>
            <button type="button" name="People2"  class="btn btn-warning btn-sm" data-toggle='modal'  data-target='#showPeople3'> Detail</button>  <table>
