        ...
        <table>
            ...
            ?>
                    ...
                    <?php $objek_sql = pg_query("SELECT * FROM kejadian
                          ...
                          ?>
                                <?php $i++; }?>
                    <select name="objek_terbakar id="objek_terbakar" class="form-control"  required>
            ...
            ?>
                    ...
                    <select id="kategori_penyebab" name="kategori_penyebab" class="form-control" required>
                       <?php
