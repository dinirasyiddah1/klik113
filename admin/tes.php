  ...
  <div id="WJSlider" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="../file/firestation/1.jpg" alt="slide1" width="460" height="345">
      ...
      <div class="item">
        <img src="../file/firestation/2.jpg" alt="slide2" width="460" height="345">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="../file/firestation/3.jpg" alt="slide3" width="460" height="345">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="../file/firestation/4.jpg" alt="slide4" width="460" height="345">
        <div class="carousel-caption">
