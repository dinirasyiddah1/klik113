      ...
      .navbar-brand
{
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <a class="navbar-brand float-left" style="align:left;" href="index.php">KLIK113 - WEBGIS Kebakaran Kota Padang</a>
...
?>
  <div class="carousel-item <?=$actives;?>">
    <img src="../file/fireincident/<?=$id;?>/<?=$data1['nama_photo'];?>" width="100%" >
  </div>
  <?php $i++; }?>
</div>
